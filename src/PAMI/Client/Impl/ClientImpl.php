 ...
 */
class ElastixWatcher implements IClient
{
	/**
	 * PSR-3 logger.
	 * @var LoggerInterface
	...
	public function __construct(array $options)
	{
		...
		$this->read_timeout = $options['read_timeout'];
	...
	public function open()
	{
		...
		{
			return var_dump('Error connecting to ami: ' . $error_message);
		}
	...
	protected function getMessages()
	{
		...
		{
			return $this->logger->log('Error reading');
		}
	...
	public function send(OutgoingMessage $message)
	{
		...
		return $this->logger->log('Read timeout.');
	}
