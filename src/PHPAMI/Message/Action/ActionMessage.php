...
require_once dirname(__FILE__) . '/../OutgoingMessage.php';
require_once dirname(__FILE__) . '/../../Exception/PHPAMIException.php';
...
abstract class ActionMessage extends OutgoingMessage
{
     ...
     *
     * @return void
     * @throws PHPAMIException When the ActionID is more then 69 characters long
     */
    public function setActionID($actionID)
    {
        if (0 == strlen($actionID)) {
            throw new PHPAMIException('ActionID cannot be empty.');
        }

        if (strlen($actionID) > 69) {
            throw new PHPAMIException('ActionID can be at most 69 characters long.');
        }
